# HTML notifications for the Booosta Framework

This modules provides notifications that can be displayed in Booosta web applications. Notifications can
be stored in the database or in the current session.
